<%@ page language="C#" autoeventwireup="true" inherits="instructor_instructor, App_Web_lqpmviu0" %>
...
<body>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" EnableAriaSupport="true" >
        <AjaxSettings>
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowSorting="true" Height="550px"
        ...
        <PagerStyle   ChangePageSizeButtonToolTip="Change Page Size"
                    ...
                    GoToPageTextBoxToolTip="Go To Page" AlwaysVisible="true" Position="TopAndBottom"></PagerStyle>
        <MasterTableView Width="100%" DataKeyNames="ID" AllowMultiColumnSorting="false" Name="Attendance" Caption="Attendance" Summary="Table holding Attendee records.">
            <SortExpressions>
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="Attended" AllowFiltering="false"  >
                    <ItemTemplate>
                          <asp:CheckBox ID="CheckBoxAttended"   Text="Click here" Autopostback="true" runat="server" Checked='<%# Bind("Attended") %>'
                ...
                <telerik:GridBoundColumn DataField="FullName" UniqueName="FullName" HeaderText="Name"
                    ...
                    Groupable="false" Reorderable="false" Visible="true" FilterControlToolTip="Type the Name">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="PrimaryEmail" UniqueName="PrimaryEmail" HeaderText="Email"
                    AllowSorting="true" ShowSortIcon="true" AllowFiltering="true" FilterControlWidth="200px"
                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                    Groupable="false" Reorderable="false" Visible="true" FilterControlToolTip="Type the Email">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="UserSiteRoomDisplay" UniqueName="UserSiteRoomDisplay"
                    ...
                    AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                    Groupable="false" Reorderable="false" Visible="true" FilterControlToolTip="Type the Location">
                </telerik:GridBoundColumn>
