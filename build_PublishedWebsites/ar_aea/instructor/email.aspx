<%@ page language="C#" autoeventwireup="true" inherits="instructor_email, App_Web_lqpmviu0" masterpagefile="~/MasterPage.master" %>
...
runat="server"></asp:Label></td>
            ...
            <tr>
                <td valign="top" colspan="2">
                  ...
                  runat="server">
                    <asp:TextBox runat="server" ID="txtComments" TextMode="MultiLine" Width="100%" Height="100px" />
                </asp:Label>
                    </td>
