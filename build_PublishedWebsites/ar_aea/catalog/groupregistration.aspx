<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="catalog_groupregistration, App_Web_n2n0cp2d" title="Group Registration" validaterequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainBody" runat="Server">
    ...
    <div align="center">
        <table>
            <tr>
                <td>
                    Search users by name, email address, or school name (first 300 results).
                </td>
            </tr>
            <tr>
                <td>
