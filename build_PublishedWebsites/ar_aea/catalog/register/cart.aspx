<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="catalog_register_cart, App_Web_agcss30h" title="Untitled Page" %>
...
<asp:Panel runat="server" ID="pPromoCode"><asp:Label ID="PromoCodeLabel"
