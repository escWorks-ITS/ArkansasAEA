<%@ page language="C#" autoeventwireup="true" inherits="shoebox_transcripts_personal, App_Web_sovcpzm0" masterpagefile="~/MasterPage.master" enableeventvalidation="false" %>
...
runat="server"></asp:Label><asp:TextBox runat="server" ID="txtEndDate" CssClass="formInput" />&nbsp;<asp:ImageButton
                ...
                <cc1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtEndDate"
                    ...
                    <asp:Button runat="server" ID="btnPrint" Text="Print" CssClass="formInput" />&nbsp;
                    <asp:CheckBox 
            runat="server" ID="chkIncludeOffical" Text="Include Official Credits" Visible
            ="false" /></td>
    </tr>
