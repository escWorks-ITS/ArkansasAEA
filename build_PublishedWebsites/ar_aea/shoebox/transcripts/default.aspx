<%@ page language="C#" autoeventwireup="true" inherits="shoebox_transcripts_default, App_Web_sovcpzm0" masterpagefile="~/MasterPage.master" enableeventvalidation="false" %>

<asp:Content runat="server" ContentPlaceHolderID="mainBody">
    <table border="0" width="100%">
        <tr>
            <td>
                The Professional Development Record allow you to track the amount of credit you
                have received from professional development
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="300" valign="top">
                            <b>Official Record</b>
                            <br />
                            <span style="font-size: 8pt;">An official record cannot be altered. It contains a record
                                of the
                                <%# region4.escWeb.SiteVariables.ObjectProvider.SessionPluralName%>
                    ...
                    <tr>
                        <td width="300" valign="top">
                            ...
                            <span style="font-size: 8pt;">A personal record can be altered. It contains a record
                                ...
                                as well as events that you have entered. This record is managed online. </span>
                            <br>
                            <br>
                            <asp:Button ID="btnPersonalTranscript" runat="Server" Text="Manage Personal Record"
                                CssClass="formInput" Style="width: 150px;" ToolTip="Click here to manage your personal record.">
                            </asp:Button>
                        </td>
                    </tr>
                    <tr>
                ...
                <table border="0" cellpadding="5" width="100%">
                    <tr>
                        <td width="65%">
                            <i>escWorks uses Adobe Acrobat&nbsp;&reg; to produce your record. If you do not have
                                Adobe Acrobat Reader&nbsp;&reg; installed on your computer, you will need to download
                                a version (free of charge) from <a href="http://www.adobe.com/" target="_blank" class="PageLink">
                                    Adobe</a>. </i>
                        </td>
                        <td nowrap>
