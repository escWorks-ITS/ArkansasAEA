<%@ page language="c#" inherits="tx_r16.Shoebox.Evaluation.Pages.DefaultPage, App_Web_rbuyw4yu" enableviewstate="False" enableviewstatemac="False" %>
        ...
        <tr>
            ...
            <td bgcolor="#ffffff">
                <span style="font-weight: bold; font-size: 12pt; color: #191970">
                    <asp:Label ID="ctrlFormTitle" runat="Server" /></span><br> <b>
                 Session ID:
                                
                                    <asp:label ID="tbSessionId" runat="Server" ></asp:label> <br>
                Title:
