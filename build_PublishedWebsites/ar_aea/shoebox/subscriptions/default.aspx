<%@ page language="C#" autoeventwireup="true" inherits="shoebox_subscriptions_default, App_Web_uxlxjsnq" enableeventvalidation="false" masterpagefile="~/MasterPage.master" %>
        ...
        <table>
            ...
            <tr>
                <td class="mainBody" align="left" colspan="2">
                    Subscription status:&nbsp;&nbsp;<asp:DropDownList ID="ddSubscribed" runat="Server"
            ...
            <tr>
                <td class="mainBody" align="left" colspan="2">
                    Would you like to receive Recommended Events by email?&nbsp;&nbsp;<asp:DropDownList
