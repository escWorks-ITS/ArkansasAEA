<%@ page language="C#" autoeventwireup="true" inherits="shoebox_account_default, App_Web_z1mrk3x3" enableeventvalidation="false" masterpagefile="~/MasterPage.master" %>
...
runat="server"></asp:Label></strong></td>
            ...
            <tr>
                ...
                <td valign="top"><asp:TextBox ID="txtSSN" runat="server" Width="276px" CssClass="formInput"></asp:TextBox></td>
...
runat="server"></asp:Label></strong></td>
            ...
            <tr>
                ...
                <td colspan="1" style="height: 45px" valign="top">
                    ...
                    <asp:TextBox ID="txtWorkPhone" Text="Work Phone" runat="server" CssClass="formInput" /><br /></td>
                <td colspan="1" style="height: 45px" valign="top">
                    &nbsp;</td>
            </tr>
            <tr>
