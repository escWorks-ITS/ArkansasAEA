<%@ page language="C#" autoeventwireup="true" inherits="shoebox_account_password, App_Web_z1mrk3x3" masterpagefile="~/MasterPage.master" %>
...
runat="server"></asp:Label><br />
                        ...
                        <table border="0" cellspacing="0" cellpadding="2" width="100%">
                            <tr>
                                <td class="mainBody">
                                    <asp:PlaceHolder ID="PasswordPlaceHolder" runat="server"><asp:Label ID="OldPasswordLabel"
text="Old Password:"
                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="4">
                                            <tr>
                                                <td class="mainBody" width="150" nowrap><asp:Label ID="NewPasswordLabel"
text="New Password:"
...
runat="server"></asp:Label>
                                            ...
                                            <tr>
                                                <td class="mainBody"><asp:Label ID="ConfirmPasswordLabel"
