<%@ page language="C#" autoeventwireup="true" inherits="security_signin, App_Web_a5pyvxwc" masterpagefile="~/MasterPage.master" %>
...
<asp:Content runat="server" ID="content1" ContentPlaceHolderID="mainBody">
   ...
   <table border=0>
   <tr><td style="width: 144px"> <asp:Label ID="UserNameLabel"
text="E-mail Address:"
AssociatedControlID="txtUserName"
runat="server"></asp:Label></td><td> <asp:TextBox runat="server" 
...
runat="server"></asp:Label>
   <tr><td style="width: 144px"> </td><td> <asp:TextBox runat="server" 
