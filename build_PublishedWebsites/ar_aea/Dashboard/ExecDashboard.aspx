<%@ page language="C#" autoeventwireup="true" inherits="ExecDashboard, App_Web_4rrdzqyc" %>
...
<head>
    ...
    <script type="text/javascript">
        function OnClientItemSelected(sender, eventArgs) {
            ...
            if (value == "2015-2016") {
                top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/569e8fcdd3ff0cd02d0003d7?folder=551c0f6d2b9d11c831000048&embed=true&l=false&r=false");
                top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/569fc02fe2cc57882d0010aa?folder=551c0f6d2b9d11c831000048&embed=true&l=false&r=false");
            }
            else if (value == "2014-2015") {
                top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/56956bd69d41b5d01b0001a2?folder=551c0f6d2b9d11c831000048&embed=true&l=false&r=false");
                top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/569e53dcd3ff0cd02d00012d?folder=551c0f6d2b9d11c831000048&embed=true&l=false&r=false");
            }
        }
    </script>
</head>
<body link="#005695" vlink="#3399ff" alink="#3399ff">
    ...
    <div class="container">
        ...
        <header>
   <br /><br />
    <h1 align="center"><em>Welcome to the AR AEA Executive Dashboard</em></h1>
    <p align="center">&nbsp;</p>
  </header>
        <h5 align="center">
            Powered by:</h5>
        ...
        <telerik:RadTabStrip ID="radTabStrip" AutoPostBack="true" runat="server" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab runat="server" Text="Professional Development" Value="Professional Development"
                 ...
                 <telerik:RadTab runat="server" Text="TA Year to Year Comparison " Value="TA Year to Year Comparison "
                    PostBack="false">
                </telerik:RadTab>
      ...
      <h3 align="center">Have a question? Contact us at: <span style="color:white; link color:white; visited color:white; hover color:white; active color:black"><a href="mailto:helpdesk@esc4.net">helpdesk@esc4.net</a></span></h3>
            ...
            <telerik:RadPageView ID="RadPageView2" height="600px" runat="server">
                ...
                <h2>
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="600px" radius-r="5px" id="iframe1" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/56956bd69d41b5d01b0001a2?folder=551c0f6d2b9d11c831000048&embed=true&l=false&r=false">
                    </iframe>
             ...
             <telerik:RadPageView ID="RadPageView3" height="600px" runat="server">
                ...
                <h2>
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="600px" radius-r="5px" id="iframe2" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/569e53dcd3ff0cd02d00012d?folder=551c0f6d2b9d11c831000048&embed=true&l=false&r=false">
                    </iframe>
              ...
              <telerik:RadPageView ID="RadPageView4" height="600px" runat="server">
                ...
                <h2>
                    ...
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="600px" radius-r="5px" id="iframe3" 
                        src="http://dashboard.escworks.net/app/main#/dashboards/56a1043ab539534c250004b4?folder=551c0f6d2b9d11c831000048&embed=true&l=false&r=false">
                    </iframe>
              ...
              <telerik:RadPageView ID="RadPageView5" height="600px" runat="server">
                ...
                <h2>
                    TA Year to Year Comparison - </h2>
                
               
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="600px" radius-r="5px" id="iframe4" 
                        src="http://dashboard.escworks.net/app/main#/dashboards/56956eca9d41b5d01b000261?folder=56956dfd9d41b5d01b00023e&embed=true&l=false&r=false">
                    </iframe>
        ...
        <h5>
            Copyright © 2015-17 escWorks.NET<sup>®</sup> All Rights Reserved
        </h5>
    </div>
    </form>
</body>
