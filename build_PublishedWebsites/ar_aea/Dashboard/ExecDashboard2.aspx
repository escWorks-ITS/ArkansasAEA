...
<%@ page language="C#" autoeventwireup="true" inherits="ExecDashboard, App_Web_o0xhtqke" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <h4 align="center"><a href="escWorks Executive Dashboard Guide ver2.pdf" title=" How To Use the Dashboard " target="_new">How to Use the Dashboard  </a>    </span></h4>
               ...
               <iframe frameborder="0" width="99.7%" height="90%" id="iframe1" 
                         src="https://www.escworks.app/qsticketprxy/sense/app/bc59defc-9e0e-4bc6-9802-76560c98bd42">
                  </iframe>
                </h2>
                <hr width="90%"/>
                 <h5>
