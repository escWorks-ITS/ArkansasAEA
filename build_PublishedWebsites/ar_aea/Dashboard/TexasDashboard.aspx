<%@ page language="C#" autoeventwireup="true" inherits="TexasDashboard, App_Web_o0xhtqke" %>
    ...
    <script type="text/javascript">
        function OnClientItemSelected(sender, eventArgs) {
            ...
            if (value == "2014-2015") {
                ...
                top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/5451762bfdd4b24807000002?folder=542acbdeae0e990421000216&embed=true");
                top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/5451770cfdd4b2480700004d?folder=542acbdeae0e990421000216&embed=true");
                top.document.getElementById('iframe4').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/5451b6dafdd4b2480700018f?folder=542acbdeae0e990421000216&embed=true");
            }
            else if (value == "2015-2016") {
                top.document.getElementById('iframe1').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/560ccfd6e5bdead008000c35?folder=560c4c8490c0666833000870&embed=true");
                top.document.getElementById('iframe2').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/560ccacfe5bdead008000b0e?folder=560c4c8490c0666833000870&embed=true");
                top.document.getElementById('iframe4').setAttribute("src", "https://dashboard.escworks.net/app/main#/dashboards/560cceaee5bdead008000be5?folder=560c4c8490c0666833000870&embed=true");
            }
        }
    </script>
</head>
    ...
    <p align="center">&nbsp;</p>
      ...
      <hr/>
                ...
                <h2 align="center">
                    About the Data...</h2>
                <h5 align="center">
                    The data within the escWorks Texas Dashboard is updated on a nightly basis. All
      ...
      <h3 align="center">Have a question? Contact us at: <span style="color:white; link color:white; visited color:white; hover color:white; active color:black"><a href="mailto:helpdesk@esc4.net">helpdesk@esc4.net</a></span></h3>
            ...
            <telerik:RadPageView ID="RadPageView2" runat="server">
                ...
                <h6>
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="500px" radius-r="5px" id="iframe1" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/5451762bfdd4b24807000002?folder=542acbdeae0e990421000216&embed=true">
                    </iframe>
                </h6>
                <hr width="90%"/>
                </footer>
            ...
            <telerik:RadPageView ID="RadPageView3" runat="server">
                ...
                <p>
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="500px"  id="iframe2" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/5451770cfdd4b2480700004d?folder=542acbdeae0e990421000216&embed=true">
                    </iframe>
                </p>
                <hr width="90%"/>
                </footer>
            ...
            <telerik:RadPageView ID="RadPageView4" runat="server">
                ...
                <h6>
                    <iframe frameborder="1" scrolling="yes" width="99.7%" height="500px" id="iframe4" 
                        src="https://dashboard.escworks.net/app/main#/dashboards/5451b6dafdd4b2480700018f?folder=542acbdeae0e990421000216&embed=true">
                    </iframe>
                </h6>
                </footer>
            </telerik:RadPageView>
        ...
        <h6>
            Copyright © 2015 escWorks.NET<sup>®</sup> All Rights Reserved
        </h6>
    </div>
    </form>
</body>
